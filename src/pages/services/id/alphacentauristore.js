  ...
  return (
    <Layout>
      <SEO
        ...
        description="Official Partner, bukan asal-asalan apalagi tipu-tipu! Info selengkapnya klik di judul."/>
      <div className={Styles.container}>
        ...
        <div className={Styles.lang}>
          <Link to="/services/id/alphacentauristore" className={Styles.selected}>Indonesia</Link>{" "}
      ...
      Metode pembayaran bervariasi, bisa dipilih sesuai keinginan!
          ...
          <ul>
            ...
            <li>Testimoni asli dan no tipu-tipu!</li>
